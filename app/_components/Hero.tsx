                ...
                <div className="mx-auto max-w-screen-md px-4 py-52 lg:flex lg:h-full lg:items-center">
                    <div className="mx-auto max-w-xl text-center">
                        <h1 className="text-3xl font-extrabold sm:text-5xl">
                            Ai Generadora de
                            <strong className="font-extrabold text-primary sm:block"> Rutas de Aprendizaje </strong>
                        </h1>

                        <p className="mt-4 sm:text-xl/relaxed">
                            Solo Imagina el titulo, has clic y desbloquea la ruta que cambiara tuvida al 100%
                        </p>
